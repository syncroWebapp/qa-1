...
git clone https://github.com/ctalau/ditaot-editlink-plugin dita-ot-2.3.3/plugins/com.oxygenxml.editlink/
...
dita-ot-2.3.3/bin/dita -i $DITAMAP -f webhelp-responsive -filter=$DITAVAL
